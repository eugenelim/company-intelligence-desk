...
- The fenced step termination the failed-append criteria require — `src/ced/adapters/postgres/event_log.py`, beside the `Fenced` mapping it shares a fence with.
